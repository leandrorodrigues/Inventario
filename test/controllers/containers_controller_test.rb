...
class ContainersControllerTest < ActionController::TestCase
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post :create, container: { container_id: @container.container_id, item_id: @container.item_id, place_id: @container.place_id, title: @container.title }
    end
  ...
  test "should update container" do
    patch :update, id: @container, container: { container_id: @container.container_id, item_id: @container.item_id, place_id: @container.place_id, title: @container.title }
    assert_redirected_to container_path(assigns(:container))
  end
